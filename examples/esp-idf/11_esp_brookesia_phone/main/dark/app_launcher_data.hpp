...
constexpr AppLauncherIcon::Data STYLESHEET_CUSTOM_DARK_APP_LAUNCHER_ICON_DATA = {
    .main = {
        .size = gui::StyleSize::SQUARE(360),
        .layout_row_pad = 10,
    },
    .image = {
...
constexpr AppLauncherData STYLESHEET_CUSTOM_DARK_APP_LAUNCHER_DATA = {
    .main = {
        .y_start = 0,
    ...
    .icon = STYLESHEET_CUSTOM_DARK_APP_LAUNCHER_ICON_DATA,
    .flags = {
