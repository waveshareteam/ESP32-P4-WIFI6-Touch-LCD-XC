...
constexpr base::Display::Data STYLESHEET_CUSTOM_DARK_CORE_DISPLAY_DATA = {
    .background = {
...
constexpr base::Manager::Data STYLESHEET_CUSTOM_DARK_CORE_MANAGER_DATA = {
    .app = {
        .max_running_num = 3,
    },
    .flags = {
...
constexpr const char *STYLESHEET_CUSTOM_DARK_CORE_INFO_DATA_NAME = "CUSTOM Dark";

constexpr base::Context::Data STYLESHEET_CUSTOM_DARK_CORE_DATA = {
    .name = STYLESHEET_CUSTOM_DARK_CORE_INFO_DATA_NAME,
    .screen_size = gui::StyleSize::RECT(BSP_LCD_H_RES, BSP_LCD_V_RES),
    .display = STYLESHEET_CUSTOM_DARK_CORE_DISPLAY_DATA,
    .manager = STYLESHEET_CUSTOM_DARK_CORE_MANAGER_DATA,
};
