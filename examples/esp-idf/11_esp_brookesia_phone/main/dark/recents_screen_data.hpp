...
constexpr RecentsScreenSnapshot::Data STYLESHEET_CUSTOM_DARK_RECENTS_SCREEN_SNAPSHOT_DATA = {
...
constexpr RecentsScreen::Data STYLESHEET_CUSTOM_DARK_RECENTS_SCREEN_DATA = {
    .main = {
    ...
    .snapshot_table = {
        ...
        .snapshot = STYLESHEET_CUSTOM_DARK_RECENTS_SCREEN_SNAPSHOT_DATA,
    },
    .trash_icon = {
